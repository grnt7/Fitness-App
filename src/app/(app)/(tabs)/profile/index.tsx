...
export default function ProfilePage() {
   ...
   //Calculate days since joining (using created at from Clerk)
...
<Text className="text-gray-600">
  Menber since {formatJoinDate(joinDate)}
</Text>
</View>
</View>
    </View>
...
<Ionicons
name="person-outline" size={20} color="6B7280"
/>
...
<TouchableOpacity className="flex-row items-center justify-between p-4 border-b border-gray-100">
<View className="flex-row items-center">
<View className="w-10 h-10 bg-yellow-300 rounded-full items-center justify-center mr-3">
<Ionicons 
